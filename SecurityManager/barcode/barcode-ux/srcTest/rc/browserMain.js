...
(function () {
  ...
  require.config({
    ...
    paths: {
      ...
      nmodule: '/module',
      'nmodule/barcode': 'build/karma/src',
      'nmodule/barcodeTest': 'build/karma/srcTest',
  ...
  define('nmodule/barcode/rc/barcode.built.min');
  ...
  require([ 'niagara-test-server/karmaUtils',
    ...
    karmaUtils.setupAndRunSpecs({
      user: 'admin',
      pass: 'asdf1234',
      specs: [ 'nmodule/barcodeTest/rc/spec/allSpecs' ]
    }, function (err) {
